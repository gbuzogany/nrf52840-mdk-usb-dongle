...
#define DEVICE_NAME                     "AutoValve"                       /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME               "wintermute.digital"                   /**< Manufacturer. Will be passed to Device Information Service. */
